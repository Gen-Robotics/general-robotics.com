      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <TechCard
            ...
            title="Proprietary Motors"
            features={[
              "Three distinct types of rotary actuators",
              "Low cost, high torque",
              "Compact and durable",
              "Patented technology",
            ]}
          />
          ...
          <TechCard
            ...
            features={[
              "Modular and foldable design",
              "Easy transportation and storage",
              "Tracks for stability and mobility",
              "Swappable forearms compatible with industrial standards",
            ]}
          />
        </div>
      </div>
